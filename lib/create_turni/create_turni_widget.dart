...
class CreateTurniWidget extends StatefulWidget {
  const CreateTurniWidget({
    Key key,
    this.turnir,
  }) : super(key: key);
  ...
  @override
  _CreateTurniWidgetState createState() => _CreateTurniWidgetState();
}

class _CreateTurniWidgetState extends State<CreateTurniWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'createTurni'});
                ...
                children: [
                  Padding(
                    ...
                    child: InkWell(
                      onTap: () async {
                        logFirebaseEvent(
                            'CREATE_TURNI_PAGE_Icon_6ccsdztg_ON_TAP');
                    ...
                    StreamBuilder<List<SportTypeRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        return FlutterFlowDropDown(
                          options: dropDownSportnameSportTypeRecord.sportname
                              .toList()
                              .toList(),
                          onChanged: (val) =>
                    ...
                    Expanded(
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          hintText: 'Напишите подробнее о тренировке',
                  ...
                  children: [
                    StreamBuilder<List<QuantityRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<QuantityRecord> dropDownQuanQuantityRecordList =
                            snapshot.data;
                        // Return an empty Container when the document does not exist.
                        if (snapshot.data.isEmpty) {
                          return Container();
                  ...
                  children: [
                    Container(
                      ...
                      child: InkWell(
                        onTap: () async {
                          logFirebaseEvent(
                              'CREATE_TURNI_PAGE_Row_w2ut54xi_ON_TAP');
                        ...
                        child: StreamBuilder<UsersRecord>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            return FFButtonWidget(
                              onPressed: () async {
                                logFirebaseEvent(
                                    'CREATE_TURNI_PAGE_СОЗДАТЬ_BTN_ON_TAP');
                                logFirebaseEvent('Button_Backend-Call');

                                final tournamentCreateData =
                                    createTournamentRecordData(
                                  location: buttonUsersRecord.locationforAdmin,
                                  date: datePicked,
                                  image: '',
                                  descr: textController.text,
                                  quantityy: '${dropDownQuanValue}',
                                );
                                await TournamentRecord.collection
                                    .doc()
                                    .set(tournamentCreateData);
                              },
                              text: 'Создать',
