...
class LikedLocationsWidget extends StatefulWidget {
  const LikedLocationsWidget({
    Key key,
    this.usr,
  }) : super(key: key);

  final UsersRecord usr;

  @override
  _LikedLocationsWidgetState createState() => _LikedLocationsWidgetState();
}

class _LikedLocationsWidgetState extends State<LikedLocationsWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'LikedLocations'});
  }
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: FlutterFlowIconButton(
          ...
          onPressed: () async {
            logFirebaseEvent('LIKED_LOCATIONS_chevron_left_sharp_ICN_O');
                        ...
                        return Padding(
                          ...
                          child: Container(
                            ...
                            child: InkWell(
                              onTap: () async {
                                logFirebaseEvent(
                                    'LIKED_LOCATIONS_Stack_3uugrbjj_ON_TAP');
