...
class LocationAllRequestsWidget extends StatefulWidget {
  const LocationAllRequestsWidget({
    Key key,
    this.loca,
  }) : super(key: key);
  ...
  @override
  _LocationAllRequestsWidgetState createState() =>
      _LocationAllRequestsWidgetState();
}

class _LocationAllRequestsWidgetState extends State<LocationAllRequestsWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'LocationAllRequests'});
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: InkWell(
          onTap: () async {
            logFirebaseEvent('LOCATION_ALL_REQUESTS_Icon_ksrp8p4g_ON_T');
          ...
          child: StreamBuilder<List<BookingRecord>>(
            stream: queryBookingRecord(
              queryBuilder: (bookingRecord) =>
                  bookingRecord.where('Location', isEqualTo: widget.loca),
            ),
                        ...
                        child: Column(
                          ...
                          children: [
                            InkWell(
                              onTap: () async {
                                logFirebaseEvent(
                                    'LOCATION_ALL_REQUESTS_Row_2r1zxqju_ON_TA');
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'LOCATION_ALL_REQUESTS_Icon_56tm7fbm_ON_T');
                                  ...
                                  Stack(
                                    children: [
                                      FFButtonWidget(
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'LOCATION_ALL_REQUESTS_ПРИНЯТЬ_BTN_ON_TAP');
                                          logFirebaseEvent(
                                              'Button_Backend-Call');
                                          ...
                                          triggerPushNotification(
                                            notificationTitle:
                                                'Подтверждение брони',
                                            notificationText:
                                                'Локация которую вы выбрали, приняла вашу бронь',
                                            notificationImageUrl:
                                                currentUserPhoto,
                                            notificationSound: 'default',
                                            userRefs: [
                                              listViewBookingRecord.user
                                            ],
                                      ...
                                      if (listViewBookingRecord.accepted ==
                                          true)
                                        FFButtonWidget(
                                          onPressed: () {
                                  ...
                                  StreamBuilder<List<OpenMatchRecord>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      return FFButtonWidget(
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'LOCATION_ALL_REQUESTS_ОТКЛОНИТЬ_BTN_ON_T');
                                          logFirebaseEvent(
                                              'Button_Backend-Call');
                                          await listViewBookingRecord.reference
                                              .delete();
