              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent('LOG_IN_PAGE_Button-Login_ON_TAP');
                          ...
                          context.pushNamedAuth('SucceLogIn', mounted);
                        },
                        text: 'Войти',
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'LOG_IN_PAGE_Button-ForgotPassword_ON_TAP');
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent('LOG_IN_PAGE_СОЗДАТЬ_BTN_ON_TAP');
                ...
                Row(
                  ...
                  children: [
                    InkWell(
                      onTap: () async {
                        logFirebaseEvent('LOG_IN_PAGE_Text_cdj8jrn9_ON_TAP');
