...
class _LoginAdminWidgetState extends State<LoginAdminWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'LoginAdmin'});
  }
                  ...
                  child: Row(
                    ...
                    children: [
                      FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'LOGIN_ADMIN_PAGE_Button-Login_ON_TAP');
                          if (widget.user.merchant) {
                            ...
                            context.pushNamedAuth('LocationAdmin', mounted);
                          }
                        },
                        text: 'Войти',
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'LOGIN_ADMIN_Button-ForgotPassword_ON_TAP');
